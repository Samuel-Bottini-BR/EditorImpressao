# Boecio, com a orla preservada

Medido em 04/08/2026 as 00:22.
...
- **12 vezes um filtro deixou a pagina pior do que ela era.** Cada caso e uma pagina com um filtro; a mesma pagina pode aparecer mais de uma vez, uma por filtro que a estragou. O criterio de aceitacao do projeto exige que esse numero seja zero.
- O programa nunca passou de **472 MB** de memoria, contra o teto de 2048 MB.
...
| Melhorar | 4.96 | 952 | 230.1 | 3.81 | 0.64 | 2205 | 0.43s |
| Mágico pro | 4.71 | 1092 | 228.5 | 3.22 | 0.59 | 2485 | 0.47s |
...
|---|---|---|---|
| Abrir o programa | 0.49 s | 10 s | sim |
| Primeiras miniaturas | 0.04 s | 5 s | sim |
| Analisar 500 folhas (projecao) | 28 s | 180 s | sim |
| Exportar 500 paginas a 300 DPI (projecao) | 55 s | 1200 s | sim |
| Pico de memoria | 472 MB | 2048 MB | sim |
...
|---|---|---|---|---|---|
| Sobre a Consolação da Filosofia - Severino B | 4 MB | 50 | 50 | 2.7s | 12 |

## Paginas que sairam piores que o original

Sao **12** ocorrencias. Cada linha e uma pagina com um filtro que a deixou pior do que ela era antes de qualquer tratamento.
...
| Sobre a Consolação da Filosofia -  | 9 | Melhorar | a borda das letras virou degrau (serrilhado): a rampa caiu de 0.72 para 0.63 pixels |
| Sobre a Consolação da Filosofia -  | 9 | Mágico pro | a borda das letras virou degrau (serrilhado): a rampa caiu de 0.72 para 0.58 pixels |
